...
from Blog.views import blog,signup,blogdetails,authordetails,bloggers,createcomment,bio,createblog,profile,deleteblog,updateblog
...
urlpatterns = [
    ...
    path('blog/<blog_id>/update/', updateblog, name='updateblog'),
